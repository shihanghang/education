            ...
            <table border=0 width=100% cellspacing=1 cellpadding=3>
                <tr>
                    ...
                    <td width="30%" align="right">
                        ...
                        <span id=txt0 name=txt0><a href='#' onclick="showsubmenu(0)" title='关闭此项'><font
                                color=#FFFFFF>↓</font></a></span>
                    </td>
                </tr>
            </table>
        </td>
        ...
        <td>
            <table border=0 width=100% cellspacing=1 cellpadding=0 class="InnerTable">
                ...
                <tr>
                    ...
                    <td colspan="3" class="InnerMain"><%=水季.get操作系统()%>
                    </td>
                </tr>
                <tr>
                    <td height="20" class="InnerHead">服务器操作系统类型</td>
                    <td class="InnerMain"><%=水季.get操作系统类型()%>
                    </td>
                    <td class="InnerHead">服务器操作系统模式</td>
                    <td class="InnerMain"><%=水季.get操作系统模式()%>
                    </td>
                </tr>
                <tr>
                    <td height="20" class="InnerHead">服务器所在地区</td>
                    <td class="InnerMain"><%=水季.get服务器所在地区()%>
                    </td>
                    <td class="InnerHead">服务器语言</td>
                    <td class="InnerMain"><%=水季.get服务器语言()%>
                    </td>
                </tr>
                <tr>
                    <td height="20" class="InnerHead">服务器时区</td>
                    <td class="InnerMain"><%=水季.get服务器时区()%>
                    </td>
                    <td class="InnerHead">服务器时间</td>
                    <td class="InnerMain"><%=水季.get服务器时间()%>
                    </td>
                </tr>
                <tr>
                    <td height="20" class="InnerHead">服务器解译引擎</td>
                    <td class="InnerMain"><%=水季.get服务器解译引擎()%>
                    </td>
                    <td class="InnerHead">服务器端口</td>
                    <td class="InnerMain"><%=水季.get服务器端口()%>
                    </td>
                </tr>
                <tr>
                    <td height="20" class="InnerHead">当前用户</td>
                    <td colspan="3" class="InnerMain"><%=水季.get当前用户()%>
                    </td>
                </tr>
                <tr>
                    <td height="20" class="InnerHead">用户目录</td>
                    <td colspan="3" class="InnerMain"><%=水季.get用户目录()%>
                    </td>
                </tr>
                <tr>
                    <td height="20" class="InnerHead">本文件实际路径</td>
                    <td colspan="3" class="InnerMain"><%=水季.get本文件实际路径()%>
                    </td>
                </tr>
            </table>
        </td>
        ...
        <td background="images/h.gif">
            <table border=0 width=100% cellspacing=1 cellpadding=3>
                <tr>
                    ...
                    <td width="30%" align="right">
                        <a href="#top" title="返回顶部"><font color=#FFFFFF>TOP</font></a>
                        <span id=txt1 name=txt1><a href='#' onclick="showsubmenu(1)" title='关闭此项'><font
                                color=#FFFFFF>↓</font></a></span>
                    </td>
                </tr>
            </table>
        ...
        <td>
            <table border=0 width=100% cellspacing=1 cellpadding=0 class="InnerTable">
                ...
                <tr>
                    ...
                    <td class="InnerMain"><%=水季.getJAVA运行环境名称()%>
                    </td>
                    <td class="InnerMain"><%=水季.getJAVA运行环境版本()%>
                    </td>
                </tr>
                <tr>
                    <td height="20" class="InnerMain">JAVA运行环境说明书名称</td>
                    <td class="InnerMain"><%=水季.getJAVA运行环境说明书名称()%>
                    </td>
                    <td class="InnerMain"><%=水季.getJAVA运行环境说明书版本()%>
                    </td>
                </tr>
                <tr>
                    <td height="20" class="InnerMain">JAVA虚拟机名称</td>
                    <td class="InnerMain"><%=水季.getJAVA虚拟机名称()%>
                    </td>
                    <td class="InnerMain"><%=水季.getJAVA虚拟机版本()%>
                    </td>
                </tr>
                <tr>
                    <td height="20" class="InnerMain">JAVA虚拟机说明书名称</td>
                    <td class="InnerMain"><%=水季.getJAVA虚拟机说明书名称()%>
                    </td>
                    <td class="InnerMain"><%=水季.getJAVA虚拟机说明书版本()%>
                    </td>
                </tr>
                <tr>
                    <td height="20" class="InnerMain">JAVA虚拟机剩余内存</td>
                    <td colspan="2" class="InnerMain"><img align=absmiddle class=PicBar
                                                           width='<%=水季.getJAVA虚拟机剩余内存百分比()%>%'> <%=水季.getJAVA虚拟机剩余内存()%>
                        M
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="2" class="InnerMain"><%=水季.getJava_class_path()%>
                    </td>
                </tr>
                <tr>
                    <td height="20" class="InnerMain">java.home</td>
                    <td colspan="2" class="InnerMain"><%=水季.getJava_home()%>
                    </td>
                </tr>
                <tr>
                    <td height="20" class="InnerMain">java.endorsed.dirs</td>
                    <td colspan="2" class="InnerMain"><%=水季.getJava_endorsed_dirs()%>
                    </td>
                </tr>
                <tr>
                    <td height="20" class="InnerMain">java.library.path</td>
                    <td colspan="2" class="InnerMain"><%=水季.getJava_library_path()%>
                    </td>
                </tr>
                <tr>
                    <td height="20" class="InnerMain">java.io.tmpdir</td>
                    <td colspan="2" class="InnerMain"><%=水季.getJava_io_tmpdir()%>
                    </td>
                </tr>
                <tr>
                ...
                %>
                <tr>
                    <td height="20" class="InnerMain"><%=相关属性名称%>
                    </td>
                    <td colspan="2" class="InnerMain"><%=相关属性.get(相关属性名称)%>
                    </td>
                </tr>
                <%}%>
            </table>
    ...
    <table border="0" align="center" cellpadding="0" cellspacing="1" class="tableBorder">
            ...
            <td background="images/h.gif">
                <table border=0 width=100% cellspacing=1 cellpadding=3>
                    <tr>
                        ...
                        <td width="30%" align="right">
                            <a href="#top" title="返回顶部"><font color=#FFFFFF>TOP</font></a>
                            <span id=txt2 name=txt2><a href='#' onclick="showsubmenu(2)" title='关闭此项'><font
                                    color=#FFFFFF>↓</font></a></span>
                        </td>
                    </tr>
                </table>
        ...
        <tr id=submenu2>
            <td>
                <table border=0 width=100% cellspacing=1 cellpadding=0 class="InnerTable">
                    <tr>
                        <td height="20" colspan="2" class="InnerHead">请查询系统的参数信息(<a
                                href="javascript:queryform.query.value='';document.queryform.submit();">枚举所有参数信息</a>)
                        </td>
                    </tr>
                    <tr>
                    ...
                    %>
                    <tr>
                        <td width="30%" height="20" align="left" class="InnerQuery"><%=名称%>
                        </td>
                        <td width="70%" align="left" class="InnerQuery"><%=信息%>
                        </td>
                    </tr>
                    <%
                            }
            ...
            <table border=0 width=100% cellspacing=1 cellpadding=3>
                <tr>
                    ...
                    <td width="15%" align="right">
                        <a href="#top" title="返回顶部"><font color=#FFFFFF>TOP</font></a>
                        <span id=txt3 name=txt3><a href='#' onclick="showsubmenu(3)" title='关闭此项'><font
                                color=#FFFFFF>↓</font></a></span>
                    </td>
                </tr>
            </table>
    ...
    <tr id=submenu3>
        <td>
            <table border=0 width=100% cellspacing=1 cellpadding=0 class="InnerTable">
                ...
                <tr>
                    <td height="20" class="InnerQuery" align="left"><font color=red>您正在使用的这台服务器</font>&nbsp; <INPUT
                            name="button" type="button" class=backc onclick="javascript:location.reload()" value="重新测试">
                    </td>
        ...
        <td background="images/h.gif">
            <table border=0 width=100% cellspacing=1 cellpadding=3>
                <tr>
                    ...
                    <td width="30%" align="right">
                        <a href="#top" title="返回顶部"><font color=#FFFFFF>TOP</font></a>
                        <span id=txt4 name=txt4><a href='#' onclick="showsubmenu(4)" title='关闭此项'><font
                                color=#FFFFFF>↓</font></a></span>
                    </td>
                </tr>
            </table>
